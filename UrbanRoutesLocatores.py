...
class Locators:
    ...
    phone_field = (By.CLASS_NAME, "np-button") #Localizador del campo de numero de telefono
    phone_value = (By.CLASS_NAME, "np-text") #Localizador para el valor del campo del numero de telefono
    ...
    #//div[contains(text(), 'Manta y pañuelos']//span[@class='slider round']- //*[@id='root']/div/div[3]/div[3]/div[2]/div[2]/div[4]/div[2]/div[1]/div/div[2]/div/span
